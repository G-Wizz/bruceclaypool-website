(function($) {
  ...
  $.fn.caroufredsel = $.fn.carouFredSel = function(options, configs) {
    ...
    FN._bind_events = function() {
      ...
      //	slideTo event
      $cfs.bind(cf_e("slideTo", conf), function(
        e,
        num,
        dev,
        org,
      ...
      $cfs.bind(cf_e("onBefore", conf) + " " + cf_e("onAfter", conf), function(
        e,
        fn
      ) {
        e.stopPropagation();
  ...
  function gn_getVisibleOrg($c, o) {
    return (
      ...
      $c
        .children()
        .slice(0, o.items.visible)
        .filter(o.items.filter).length
    );
  }
